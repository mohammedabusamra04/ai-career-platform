...
import { jobPipelineService } from '../../src/config/services.js';
import router from '../../src/modules/jobs/job.pipeline.route.js';

vi.mock('../../src/config/services.js', () => ({
  jobPipelineService: {
    run: vi.fn(),
  },
}));
